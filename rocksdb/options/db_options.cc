...
static std::unordered_map<std::string, OptionTypeInfo>
    db_immutable_options_type_info = {
        ...
        {"async_zc_enabled",
         {offsetof(struct ImmutableDBOptions, async_zc_enabled),
          OptionType::kUInt64T, OptionVerificationType::kNormal,
          OptionTypeFlags::kNone}},  
        ...
        {"default_extent_size",
         ...
         {offsetof(struct ImmutableDBOptions, pca_selection),
          ...
          OptionTypeFlags::kNone}},  
            {"row_cache_size",
         {offsetof(struct ImmutableDBOptions, row_cache_size),
          OptionType::kUInt64T, OptionVerificationType::kNormal,
          OptionTypeFlags::kNone}},  
        {"compaction_scheme",
        ...
        {"enable_intraL0_compaction",
         {offsetof(struct ImmutableDBOptions, enable_intraL0_compaction),
          ...
          OptionTypeFlags::kNone}},  
        {"until",
         {offsetof(struct ImmutableDBOptions, until),
          OptionType::kUInt64T, OptionVerificationType::kNormal,
          OptionTypeFlags::kNone}},  
        {"zc",
...
ImmutableDBOptions::ImmutableDBOptions(const DBOptions& options)
    : create_if_missing(options.create_if_missing),
      ...
      row_cache_size(options.row_cache_size),
