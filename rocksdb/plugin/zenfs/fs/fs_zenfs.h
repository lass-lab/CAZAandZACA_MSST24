...
class ZenFS : public FileSystemWrapper {
  ...
  void LargeIOSyncFileExtents(std::map<ZoneFile*,std::vector<ZoneExtent*>>& lock_acquired_files);
...
ret:
  ...
  IOStatus SMRLargeIOMigrateExtents(const std::vector<ZoneExtentSnapshot*>& extents) __attribute__((hot)) ;
