...
#define WAL_IO_PRIORITY IOPRIO_PRIO_VALUE(IOPRIO_CLASS_RT,1) //NOT SET
#define FLUSH_IO_PRIORITY IOPRIO_PRIO_VALUE(IOPRIO_CLASS_RT,2) // NOT SET
#define L0_to_L1_COMPACTION_IO_PRIORITY IOPRIO_PRIO_VALUE(IOPRIO_CLASS_RT,3)
#define L1_to_L2_COMPACTION_IO_PRIORITY IOPRIO_PRIO_VALUE(IOPRIO_CLASS_RT,5)
// #define ZC_COMPACTION_IO_PRIORITY IOPRIO_PRIO_VALUE(IOPRIO_CLASS_RT,4)
#define ELSE_COMPACTION_IO_PRIORITY IOPRIO_PRIO_VALUE(IOPRIO_CLASS_BE,1)
...
class DBImpl : public DB {
 public:
  ...
  virtual uint64_t MostLargeUpperAdjacentFile(Slice& s, Slice& l, int level) override;
  virtual uint64_t MostSmallDownwardAdjacentFile(Slice& s, Slice& l, int level) override;
  ...
  virtual std::set<uint64_t> GetSoonCompactionInvalidatedSSTFileNo(int level,int depth,uint64_t* pivot_sst_fno) override;
